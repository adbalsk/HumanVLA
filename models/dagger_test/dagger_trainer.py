...
class DaggerTestTrainer:
    def __init__(self, cfg,  env) -> None:
        ...
        self.goal_dim = cfg.student_network.goal_dim = self.env.num_goal_obs
        ...
        buffer_info_dict = {
            ...
            'goal'       :   dict(shape = (self.buffer_size, self.goal_dim)),
        ...
        for ep in range(1, self.cfg.max_epoch + 1):
            ...
            for j in range(self.cfg.num_train_iters):
                ...
                with torch.cuda.amp.autocast(enabled=self.auto_mixed_precision):
                    action = self.ddp_network(prop, goal, image, last_action, last_imgs)
